...
public class BrowserFactory {
    ...
    private static WebDriver startChrome(){
        ...
        options.setCapability("networkname:applicationName", "node_"+RandomUtil.randomText(3));
        options.setCapability("nodename:applicationName", "app_2"+RandomUtil.randomText(3));
